...
<div class="row my-5">
    <div class="row px-5">
        ...
        <div class="col-4">
            <h4>Departamento Solicitante</h4>
            <h5 class="font" style="font-weight: bold;">{{$rdo['nombre_departamento']}}</h5>
        </div>
        <div class="col-4">
    ...
    <div class="row px-5 mt-5">
        <div class="col-4">
            ...
            <h5 class="font" style="font-weight: bold;">{{$rdo['numero_productos']}}</h5>
        </div>
        <div class="col-4">
